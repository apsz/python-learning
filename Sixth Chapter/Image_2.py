...
class Image:
    ...
    def resize(self, length=None, height=None):
        height = self.__height or height
        length = self.__length or length
        if self.__length == length and self.__height == height:
            return False
        ...
        self.__length = length
        self.__height = height
        self.__colors = set(self.__data.values()) | {self.__background_color}
        return True
